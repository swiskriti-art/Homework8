...
Renaming variables for easy use
...
From the above `psych::describe`, there are no missing data in any of the columns with summary looks proper.
...
Creating factors of the categorical variables
